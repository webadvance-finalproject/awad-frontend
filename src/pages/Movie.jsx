...
import { Box, Typography, Card, CardMedia, CardContent, Grid, Chip } from '@mui/material';
                ...
                <div className={styles.container}> 
                    ...
                    {user && movie && (
                          <Box   sx={{
                            ...
                            // backgroundPosition: 'left calc((50vw - 170px) - 340px) top', // Dịch ảnh sang trái
                            backgroundRepeat: 'no-repeat',
                            width: '1928',  // Chiều rộng full màn hình
                            ...
                            <Grid item xs={12} md={8}>
                              <Card sx={{backgroundColor:"transparent", border:"none", boxShadow: 'none'}}>
                                <CardContent>
                                  ...
                                  {/* <Box sx={{ marginTop: 2 }}>
                                    ...
                                    <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
                                      {cast.map((actor, index) => (
                                        <Box key={index} sx={{ marginRight: 2, marginBottom: 2, display: 'flex', alignItems: 'center' }}>
                                          <Avatar src={actor.image} sx={{ width: 30, height: 30, marginRight: 1 }} />
                                  ...
                                  {/* Play Trailer Button */}
                                  {/* <Box sx={{ marginTop: 3 }}>
                                    <Button variant="contained" color="primary" href={movie.trailerLink}>
                                      Play Trailer
                                    </Button>
                                  </Box> */}
                                </CardContent>
